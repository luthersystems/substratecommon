...
func WithParam(arg interface{}) substratecommon.Config {
	return substratecommon.WithParams([]interface{}{arg})
}
...
func WithSeed() (substratecommon.Config, error) {
	...
	return substratecommon.WithTransientData("csprng_seed_private", seed), nil
}
...
func WithTransientMXF(req *EncodeRequest) ([]substratecommon.Config, error) {
	if req == nil {
		req = &EncodeRequest{}
	}
	var configs []substratecommon.Config
	...
	configs = append(configs, substratecommon.WithTransientData("mxf", reqBytes))
	return configs, nil
}
...
func Encode(ctx context.Context, client substratewrapper.SubstrateInstanceWrapperCommon, message interface{}, transforms []*Transform, configs ...substratecommon.Config) (*EncodedResponse, error) {
	...
	resp, err := client.Call(ShiroEndpointEncode, configs...)
	if err != nil {
		return nil, err
	}
	if resp.HasError {
...
func Export(ctx context.Context, client substratewrapper.SubstrateInstanceWrapperCommon, dsid DSID, exported map[string]interface{}, configs ...substratecommon.Config) error {
	...
	resp, err := client.Call(ShiroEndpointExport, configs...)
	if err != nil {
		return err
	}
	if resp.HasError {
...
func Purge(ctx context.Context, client substratewrapper.SubstrateInstanceWrapperCommon, dsid DSID, configs ...substratecommon.Config) error {
	...
	configs = append(configs, seedConfig)
	resp, err := client.Call(ShiroEndpointPurge, configs...)
	if err != nil {
		return err
	}
	if resp.HasError {
